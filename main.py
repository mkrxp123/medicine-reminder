...
def search_img():
    ...
    '''
    return send_file(io.BytesIO(b64.b64decode(base64)), mimetype=f'image/{form}')
...
def handle_message(event):
    ...
    if text == '網址':
            ...
            FlexSendMessage(
                ...
                contents={
                    ...
                    "hero": {
                        "type": "image",
                        "url":
                        "https://medicine-reminder.r890910.repl.co/search-img?ReminderID=88",
                        "size": "full",
                        "aspectRatio": "20:13",
                        "aspectMode": "cover",
                        "action": {
        ...
        line_bot_api.reply_message(
            event.reply_token,
            FlexSendMessage(alt_text='謝謝您的填寫!',
                            contents={
                                "type": "bubble",
                                "body": {
                                    "type":
                                    ...
                                    "contents": [{
                                        ...
                                        "type": "text",
                                        "text":
                                        "為了增進提醒功能，接下來我會問您幾個問題，若準備好請按下方按鈕",
                                        "wrap": True,
                                        "margin": "xl"
                                    }]
                                },
